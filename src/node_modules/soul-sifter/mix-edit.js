...
class MixEdit extends LitElement {
  render() {
    return html`
      <abstract-action-page @cancel="${this.exit}" @accept="${this.save}">
        ...
        <div class="fields">
          <paper-input floatingLabel label="Rank (0 - 99)" value="${this.mix.rank}" id="rank" auto-validate allowed-pattern="[0-9]"></paper-input>
  ...
  save(e) {
    ...
    this.mix.rank = this.shadowRoot.getElementById('rank').value;
