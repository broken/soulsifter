...
class SettingsEdit extends SettingsMixin(LitElement) {
    ...
    return html`
      <abstract-action-page @cancel="${this.exit}" @accept="${this.save}">
        ...
        <div class="fields">
          ...
          <paper-input label="Google OAuth Token" value="${this.googleOauthToken}" id="googleOauthToken"></paper-input>
        </div>
  ...
  save(e, detail, sender) {
    ...
    this.settings.save();
    if (!!this.shadowRoot.getElementById('googleOauthToken').value) {
      window.yt.saveNewToken(this.shadowRoot.getElementById('googleOauthToken').value);
    }
    this.exit();
  }
