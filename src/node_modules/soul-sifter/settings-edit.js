...
class SettingsEdit extends SettingsMixin(LitElement) {
  ...
  constructor() {
    ...
    this.songListSearchOnSelectOriginalValue = this.songListSearchOnSelect;
    this.songListShowComments = this.settings.getBool('songList.showComments');
    this.songListShowCommentsOriginalValue = this.songListShowComments;
    this.includeUnknownKeys = this.settings.getBool('search.includeUnknownKeys');
    this.includeUnknownKeysOriginalValue = this.includeUnknownKeys;
  ...
  save(e, detail, sender) {
    ...
    this.putb('songList.searchOnSelect', this.shadowRoot.getElementById('songListSearchOnSelect').checked, this.songListSearchOnSelectOriginalValue);
    this.putb('songList.showComments', this.shadowRoot.getElementById('songListShowComments').checked, this.songListShowCommentsOriginalValue);
    this.putb('search.includeUnknownKeys', this.shadowRoot.getElementById('includeUnknownKeys').checked, this.includeUnknownKeysOriginalValue);
    this.putb('tag.readOverwrite', this.shadowRoot.getElementById('overwriteSongFromTag').checked, this.overwriteSongFromTagOriginalValue);
    this.settings.save();
    this.exit();
  }
