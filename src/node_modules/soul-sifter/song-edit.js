...
class SongEdit extends LitElement {
  ...
  validate() {
    ...
    if (this.shadowRoot.getElementById('basicGenreInput').value == '') valid = false;
    return valid;
  }
  ...
  artistChanged(e) {
    ...
    if (!!artist &&
        ((!!this.taggedSong.album.artist && this.taggedSong.artist == this.taggedSong.album.artist) ||
         (!this.taggedSong.album.artist && this.taggedSong.artist == this.song.album.artist))) {
  ...
  titleChanged(e) {
    ...
    if (!!title &&
        ((!!this.taggedSong.album.name && this.taggedSong.title == this.taggedSong.album.name) ||
         (!this.taggedSong.album.name && this.taggedSong.title == this.song.album.name))) {
