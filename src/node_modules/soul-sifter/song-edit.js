...
class SongEdit extends LitElement {
  render() {
    let basicGenreItems = this.basicGenreList.map(g => html`<paper-item label="${g.name}">${g.name}</paper-item>`);
    return html`
      <abstract-action-page id="abstractActionPage" @cancel="${this.skip}" @accept="${this.save}">
        ...
        <div class="fields">
          ...
          <paper-dropdown-menu label="Artist Genre" required>
            <paper-listbox slot="dropdown-content" selected="${this.basicGenreName}" attr-for-selected="label">
              ${basicGenreItems}
            </paper-listbox>
          </paper-dropdown-menu>
