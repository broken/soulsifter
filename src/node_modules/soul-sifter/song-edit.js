      ...
      <div class="relative">
        <abstract-action-page id="abstractActionPage" @cancel="${this.skip}" @accept="${this.save}">
          <div class="fields">
            ...
            <paper-input label="Artist" value="${this.editedSong.artist}" required="true" floatingLabel id="artist"></paper-input>
            ...
            <paper-input label="Title" value="${this.editedSong.title}" required="true" floatingLabel id="title"></paper-input>
            ...
            <div class="cols">
              ...
              <div id="cover" @click="${this.changeCover}"></div>
              <input style="display:none;" id="coverFileDialog" type="file" nwworkingdir="${editedSongFilepath}" @change="${this.changeFileAction}"/>
            </div>
          </div>
          <div class="fields">
            <div class="prev">&nbsp;<span>${this.taggedSong.album.artist}</span></div>
            <paper-input label="Album Artist" value="${this.editedSong.album.artist}" floatingLabel id="album_artist"></paper-input>
        ...
        <div class="metadata">
          <div class="audio"><ss-audio id="audio" .song="${this.song}"></ss-audio></div>
          <div>${this.editedSong.id}</div>
          <div on-click="_changeSong">${this.editedSong.filepath}</div>
          <input style="display:none;" id="songFileDialog" type="file" nwworkingdir="${editedSongFilepath}"/>
        </div>
      </div>
    `;
  }
