...
class GenreEdit extends LitElement {
  render() {
    return html`
      <abstract-action-page id="abstractActionPage" @cancel="${this.exit}" @accept="${this.save}">
        <div class="fields">
          <paper-input floatingLabel label="Name" value="${this.genre.name}"></paper-input>
        </div>
        <div class="genres">
          <genre-list id="genreList" .genres="${this.genreParents}" single-select></genre-list>
        </div>
