...
import { } from "@material/mwc-top-app-bar";
...
class SoulSifter extends LitElement {
    ...
    */
      ...
      <mwc-drawer>
        ...
        <main slot="appContent">
          <mwc-top-app-bar dense="true">
            <div slot="title">Search Toolbar</div>
          </mwc-top-app-bar>
          <song-list class="top-app-bar-adjust"></song-list>
        </main>
      </mwc-drawer>
    `;
  }
  ...
  changeQuery(e, detail, sender) {  // TODO
    this.query = detail;
  }
