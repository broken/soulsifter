...
class SongListItem extends BpmMixin(GenresMixin(SettingsMixin(SongMixin(LitElement)))) {
  render() {
  ...
  selectSong(e) {
    ...
    if (this.dynamicGenreMode) this.changeGenres(this.song.styles);
  }
