...
class SongListItem extends BpmMixin(SettingsMixin(SongMixin(LitElement))) {
  render() {
    return html`
  ...
  firstUpdated(changedProperties) {
    this.shadowRoot.getElementById('cover').style.backgroundImage = 'url("file://' + this.settings.getString('music.dir') + this.song.album.coverFilepath + '")';
  }
