...
import { } from "@polymer/paper-dialog";
...
class SearchToolbar extends BpmMixin(QueryMixin(SearchMixin(LitElement))) {
  render() {
    return html`
      ...
      <options-menu>
        <options-menu-item on-click="addSongFromUrl">Add Song From URL</options-menu-item>
  ...
  static get properties() {
    return {
      searchOptionBpmRestrict: { type: Boolean, notify: true },
      searchOptionKeyRestrict: { type: Boolean, notify: true },
      searchOptionTrashedRestrict: { type: Boolean, notify: true },
      searchOptionRepeatRestrict: { type: Boolean, notify: true },
      nwGui: { type: Object },
    }
  }
  ...
  toggleSearchOptionsDialog(e, detail, sender) {
