  ...
  render() {
    return html`
      ...
      <options-menu>
        ...
        <options-menu-item on-click="${this.analyzeDurations}">Analyze Durations</options-menu-item>
        <options-menu-item @click="${this.syncGoogleMusic}">Sync Google Music</options-menu-item>
        <options-menu-item on-click="${this.syncGoogleMusicPlaylists}">Sync Google Music Playlists</options-menu-item>
